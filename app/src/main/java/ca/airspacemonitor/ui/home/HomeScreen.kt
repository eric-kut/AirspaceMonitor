...
import ca.airspacemonitor.service.ProfileRun
...
private fun mergePins(
    ...
    settings: ca.airspacemonitor.data.AppSettings,
): List<AircraftPin> {
...
private fun pinLabel(m: ca.airspacemonitor.domain.MatchedAircraft, settings: ca.airspacemonitor.data.AppSettings): String {
