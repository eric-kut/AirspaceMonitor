...
import ca.airspacemonitor.data.db.EventEntity
...
class MonitoringService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "ca.airspacemonitor.action.START"
        const val ACTION_STOP = "ca.airspacemonitor.action.STOP"
        const val ACTION_STOP_PROFILE = "ca.airspacemonitor.action.STOP_PROFILE"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        container = (application as AirspaceApp).container
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "AirspaceMonitor:monitor").apply {
